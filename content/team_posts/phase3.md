...
| student/train                        | NA                                      | adds the training data to database | NA | NA |
| student/test    | retrieves the mean squared error and r2                    | NA                                 | NA | NA |
| student/predict | NA                                                         | adds predicted data to database    | NA | NA |
| student/params  | retrieves student_id, scalar_std, scalar_mean, beta_values | NA                                 | NA | NA |
